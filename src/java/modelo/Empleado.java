...
public class Empleado extends Persona {
    ...
    public DefaultTableModel leer() {
        ...
        try {
            ...
            cn = new Conexion();
            String query = "SELECT e.id_empleados as id, e.codigo, e.nombres, e.apellidos, e.direccion, e.telefono, e.fecha_nacimiento, p.puesto, p.id_puesto FROM empleados e INNER JOIN puesto p ON e.id_puesto = p.id_puesto;";
            cn.abrir_conexion();
    ...
    public int modificar() {
        ...
        try {
            ...
            result = parametro.executeUpdate();
            cn.cerrar_conexion();
